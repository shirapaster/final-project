...
class TestDataCleaning(unittest.TestCase):
    ...
    def test_fill_missing_values_by_group(self):
        ...
        filled_data = fill_missing_values_by_group(mock_data, ['BDNF_N'], ['Genotype', 'Treatment'])
    ...
    def test_detect_outliers(self):
        ...
        mock_data = pd.DataFrame({'BDNF_N': [1, 1.5, 2, 3, 100]})
        outliers = detect_outliers(mock_data, 'BDNF_N', factor=3)
